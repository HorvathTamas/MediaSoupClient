...
export default class MediaSoupClient
{
    ...
    this._protoo.on('request', async (request, accept, reject) =>
    {
      ...
      switch (request.method)
      {
        case 'newConsumer':
        {
          ...
          {
            console.err('"newConsumer" request failed:%o', error);

            console.log(`Error creating a Consumer: ${error}`)
            // store.dispatch(requestActions.notify(
            // 	{
            // 		type : 'error',
        ...
        case 'newDataConsumer':
        {
          ...
          try
          {
            ...
            {
              console.warn('DataConsumer "open" event');
            });
            ...
            dataConsumer.on('close', () =>
            {
              ...
              console.log('DataConsumer closed')
              // store.dispatch(requestActions.notify(
              // 	{
              // 		type : 'error',
            ...
            {
              console.err('DataConsumer "error" event:%o', error);
          ...
          {
            console.err('"newDataConsumer" request failed:%o', error);

            console.log(`Error creating a DataConsumer: ${error}`);
            // store.dispatch(requestActions.notify(
            // 	{
            // 		type : 'error',
  ...
  async enableMic()
  {
    ...
    {
      console.err('enableMic() | cannot produce audio');
    ...
    try
    {
      ...
      {
        console.warn('enableMic() | calling getUserMedia()');
    ...
    {
      console.err('enableMic() | failed:%o', error);
  ...
  async muteMic()
  {
    ...
    {
      console.err('muteMic() | failed: %o', error);

      console.log(`Error pausing server-side mic Producer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async unmuteMic()
  {
    ...
    {
      console.err('unmuteMic() | failed: %o', error);

      console.log(`Error resuming server-side mic Producer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async enableWebcam()
  {
    ...
    {
      console.err('enableWebcam() | cannot produce video');
    ...
    try
    {
      if (!this._externalVideo)
      {
        ...
        console.warn('enableWebcam() | calling getUserMedia()');
    ...
    {
      console.err('enableWebcam() | failed:%o', error);

      console.log(`Error enabling webcam: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async changeWebcam()
  {
    ...
    try
    {
      ...
      console.warn('changeWebcam() | calling getUserMedia()');
    ...
    {
      console.err('changeWebcam() | failed: %o', error);

      console.log(`Could not change webcam: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('changeWebcamResolution()');
    ...
    try
    {
      ...
      console.warn('changeWebcamResolution() | calling getUserMedia()');
    ...
    {
      console.err('changeWebcamResolution() | failed: %o', error);

      console.log(`Could not change webcam resolution: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async enableShare()
  {
    ...
    if (!this._mediasoupDevice.canProduce('video'))
    {
      console.err('enableShare() | cannot produce video');
    ...
    try
    {
      console.warn('enableShare() | calling getUserMedia()');
    ...
    {
      console.err('enableShare() | failed:%o', error);
  ...
  async disableShare()
  {
    ...
    {
      console.log(`Error closing server-side share Producer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async restartIce()
  {
    ...
    {
      console.err('restartIce() | failed:%o', error);
  ...
  {
    console.warn('setMaxSendingSpatialLayer() [spatialLayer:%s]', spatialLayer);
    ...
    {
      console.err('setMaxSendingSpatialLayer() | failed:%o', error);

      console.log(`Error setting max sending video spatial layer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async setConsumerPreferredLayers(consumerId, spatialLayer, temporalLayer)
  {
    ...
    {
      console.err('setConsumerPreferredLayers() | failed:%o', error);

      console.log(`Error setting Consumer preferred layers: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async setConsumerPriority(consumerId, priority)
  {
    ...
    {
      console.err('setConsumerPriority() | failed:%o', error);

      console.log(`Error setting Consumer priority: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('requestConsumerKeyFrame() [consumerId:%s]', consumerId);

    try
    {
      await this._protoo.request('requestConsumerKeyFrame', { consumerId });

      console.log('Keyframe requested for video consumer');
      // store.dispatch(requestActions.notify(
      // 	{
    ...
    {
      console.err('requestConsumerKeyFrame() | failed:%o', error);

      console.log(`Error requesting key frame for Consumer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('enableChatDataProducer()');
    ...
    try
    {
      ...
      {
        console.warn('chat DataProducer "open" event');
      });

      this._chatDataProducer.on('close', () =>
      {
        console.err('chat DataProducer "close" event');
      ...
      {
        console.err('chat DataProducer "error" event:%o', error);

        console.log(`Chat DataProducer error: ${error}`);
        // store.dispatch(requestActions.notify(
        // 	{
        // 		type : 'error',
      ...
      {
        console.warn('chat DataProducer "bufferedamountlow" event');
      });
    }
    catch (error)
    {
      console.err('enableChatDataProducer() | failed:%o', error);

      console.log(`Error enabling chat DataProducer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('enableBotDataProducer()');
    ...
    try
    {
      ...
      {
        console.warn('bot DataProducer "open" event');
      });

      this._botDataProducer.on('close', () =>
      {
        console.err('bot DataProducer "close" event');

        this._botDataProducer = null;

        console.log('Bot DataProducer closed');
        // store.dispatch(requestActions.notify(
        // 	{
        // 		type : 'error',
      ...
      {
        console.err('bot DataProducer "error" event:%o', error);

        console.log(`Bot DataProducer error: ${error}`);
        // store.dispatch(requestActions.notify(
        // 	{
        // 		type : 'error',
      ...
      {
        console.warn('bot DataProducer "bufferedamountlow" event');
      });
    }
    catch (error)
    {
      console.err('enableBotDataProducer() | failed:%o', error);

      console.log(`Error enabling bot DataProducer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('sendChatMessage() [text:"%s]', text);

    if (!this._chatDataProducer)
    {
      console.log('No chat DataProducer');
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
    ...
    {
      console.err('chat DataProducer.send() failed:%o', error);

      console.log(`chat DataProducer.send() failed: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('sendBotMessage() [text:"%s]', text);

    if (!this._botDataProducer)
    {
      console.log('No bot DataProducer');
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
    ...
    {
      console.err('bot DataProducer.send() failed:%o', error);

      console.log(`bot DataProducer.send() failed: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('changeDisplayName() [displayName:"%s"]', displayName);
    ...
    {
      console.err('changeDisplayName() | failed: %o', error);

      console.log(`Could not change display name: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('getSendTransportRemoteStats()');
  ...
  {
    console.warn('getRecvTransportRemoteStats()');
  ...
  {
    console.warn('getAudioRemoteStats()');
  ...
  {
    console.warn('getVideoRemoteStats()');
  ...
  {
    console.warn('getConsumerRemoteStats()');
  ...
  {
    console.warn('getChatDataProducerRemoteStats()');
  ...
  {
    console.warn('getBotDataProducerRemoteStats()');
  ...
  {
    console.warn('getDataConsumerRemoteStats()');
  ...
  {
    console.warn('getSendTransportLocalStats()');
  ...
  {
    console.warn('getRecvTransportLocalStats()');
  ...
  {
    console.warn('getAudioLocalStats()');
  ...
  {
    console.warn('getVideoLocalStats()');
  ...
  async applyNetworkThrottle({ uplink, downlink, rtt, secret })
  {
    ...
    {
      console.err('applyNetworkThrottle() | failed:%o', error);

      console.log(`Error applying network throttle: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  {
    console.warn('resetNetworkThrottle()');
    ...
    catch (error)
    {
      if (!silent)
      {
        console.err('resetNetworkThrottle() | failed:%o', error);

        console.log(`Error resetting network throttle: ${error}`);
        // store.dispatch(requestActions.notify(
        // 	{
        // 		type : 'error',
  ...
  async _joinRoom()
  {
    ...
    {
      console.err('_joinRoom() failed:%o', error);
  ...
  {
    console.warn('_updateWebcams()');

    // Reset the list.
    this._webcams = new Map();

    console.warn('_updateWebcams() | calling enumerateDevices()');
    ...
    console.warn('_updateWebcams() [webcams:%o]', array);
  ...
  _getWebcamType(device)
  {
    ...
    {
      console.warn('_getWebcamType() | it seems to be a back camera');

      return 'back';
    }
    else
    {
      console.warn('_getWebcamType() | it seems to be a front camera');
  ...
  async _pauseConsumer(consumer)
  {
    ...
    {
      console.err('_pauseConsumer() | failed:%o', error);

      console.log(`Error pausing Consumer: ${error}`);
      // store.dispatch(requestActions.notify(
      // 	{
      // 		type : 'error',
  ...
  async _resumeConsumer(consumer)
  {
    ...
    {
      console.err('_resumeConsumer() | failed:%o', error);
